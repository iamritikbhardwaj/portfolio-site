...
const page: React.FC = () => {
  ...
  const skills: Skill[] = [
    ...
    { name: "TypeScript", color: "blue", level: 65 },
    ...
    { name: "Solana", color: "green", level: 30 },
  ];
  ...
  const projects: Project[] = [
    ...
    {
      title: "gorecon – Go-Based Web Recon Scanner",
      description:
    ...
    //   description:
    //     "Decentralized voting application built on Ethereum blockchain.",
              ...
              {socialLinks.map(({ href, icon: Icon, label, hoverColor }) => (
                <Link
                  ...
                  className={`${styles.socialLink} ${
                    styles[
                      `socialLink${
                        hoverColor.charAt(0).toUpperCase() + hoverColor.slice(1)
                      }`
                    ]
                  }`}
                  aria-label={label}
      ...
      <section id="home" className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.heroTitle}>
            <span className={styles.gradientText}>Ritik Singh</span>
          </h1>

          <p className={styles.heroSubtitle}>Full Stack Developer</p>

          <p className={styles.heroDescription}>
            I speak in <code className={styles.codeTag}>&lt;code&gt;</code> so
            you don't have to.
          </p>
        ...
        <div className={styles.sectionContainer}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDescription}>
              ...
              innovative solutions with modern technologies. I enjoy using my
                  ...
                  <div className={styles.skillHeader}>
                    <span
                      className={`${styles.skillName} ${
                        styles[
                          `skill${
                            skill.color.charAt(0).toUpperCase() +
                            skill.color.slice(1)
                          }`
                        ]
                      }`}
            ...
            <div className={styles.servicesSection}>
              ...
              <div className={styles.servicesList}>
                {[
                  ...
                  "Backend Development with Node.js, Go, and cloud services",
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContent}>
          <p className={styles.footerText}>
            ...
            <span className={styles.footerName}>Ritik Singh</span>
